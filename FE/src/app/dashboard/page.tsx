...
export default async function Dashboard() {
    ...
    const userData = {
        ...
        clips: [
            { id: "clip1", title: "Funny moment 1", s3Key: "clip_key_1", createdAt: new Date(), uploadedFileId: "1", views: 100, videoUrl: "https://example.com/clip1.mp4", thumbnailUrl: "https://example.com/thumb1.jpg" },
