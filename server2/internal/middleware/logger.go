...
// LoggerMiddleware returns a Gin middleware which logs HTTP requests/responses
func LoggerMiddleware() gin.HandlerFunc {
	// Log path relative to cmd/server/ -> ../../logs/http.log creates logs/ at server2 root
